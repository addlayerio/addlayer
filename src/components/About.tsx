                ...
                return (
                  <div key={index} className="space-y-3">
                    <div className="flex items-center space-x-3">
                      <div className="w-10 h-10 bg-addlayer-green/10 rounded-lg flex items-center justify-center">
                        <Icon className="w-5 h-5 text-addlayer-green" />
                      </div>
                      <h3 className="font-semibold text-addlayer-dark">{value.title}</h3>
                    </div>
            ...
            <div className="relative z-10">
              ...
              <div className="space-y-4">
                <div className="h-20 bg-addlayer-gradient rounded-xl opacity-90 flex items-center justify-center">
                  <span className="text-white font-bold text-lg">VISIÓN</span>
                </div>
                <div className="h-20 bg-addlayer-green/80 rounded-xl ml-8 flex items-center justify-center">
                  <span className="text-white font-bold text-lg">ESTRATEGIA</span>
                </div>
                <div className="h-20 bg-addlayer-green/60 rounded-xl ml-16 flex items-center justify-center">
                  <span className="text-white font-bold text-lg">DESARROLLO</span>
                </div>
                <div className="h-20 bg-addlayer-green/40 rounded-xl ml-24 flex items-center justify-center">
                  <span className="text-addlayer-dark font-bold text-lg">IMPLEMENTACIÓN</span>
                </div>
                <div className="h-20 bg-addlayer-green/20 rounded-xl ml-32 flex items-center justify-center">
                  <span className="text-addlayer-dark font-bold text-lg">ÉXITO</span>
                </div>
              </div>
            </div>
