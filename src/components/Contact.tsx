...
const Contact = () => {
  return (
    <section id="contact" className="py-20 bg-addlayer-darker text-white">
      <div className="container mx-auto px-6">
        ...
        <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-6">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-300">contacto@addlayer.com</p>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-300">Ciudad Tech, Innovation District</p>
                </div>
              </div>
            </div>
          </div>
          ...
          {/* Contact Form */}
          <Card className="bg-white/5 border-addlayer-green/20">
            <CardHeader>
            ...
            <CardContent className="space-y-6">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    type="text"
                    className="w-full px-4 py-3 bg-white/10 border border-addlayer-green/30 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:border-addlayer-green"
              ...
              <div>
                ...
                <textarea
                  rows={4}
                  className="w-full px-4 py-3 bg-white/10 border border-addlayer-green/30 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:border-addlayer-green resize-none"
                  placeholder="Describe tu visión, objetivos y cómo podemos ayudarte..."
                ></textarea>
              </div>

              <Button className="w-full bg-addlayer-green hover:bg-addlayer-green/90 text-white py-3 text-lg group">
                Enviar Consulta
