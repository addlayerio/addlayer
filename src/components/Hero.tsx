...
const Hero = () => {
  return (
    <section id="home" className="min-h-screen flex items-center bg-gradient-to-br from-white via-gray-50 to-addlayer-green/5 pt-20">
      <div className="container mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          {/* Left Content */}
          <div className="space-y-8 animate-fade-in">
            <div className="space-y-4">
              <h1 className="text-5xl lg:text-7xl font-bold text-addlayer-dark leading-tight">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button 
                size="lg" 
                className="bg-addlayer-green hover:bg-addlayer-green/90 text-white px-8 py-4 text-lg group"
              >
                Comenzar Proyecto
              ...
              <Button 
                variant="outline" 
                size="lg" 
                className="border-addlayer-green text-addlayer-green hover:bg-addlayer-green hover:text-white px-8 py-4 text-lg"
              >
                Ver Servicios
              </Button>
            </div>
